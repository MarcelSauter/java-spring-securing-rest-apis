...
public class UserRepositoryOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
    ...
    public OAuth2AuthenticatedPrincipal introspect(String token) {
        ...
        return new UserOAuth2AuthentcatedPrincipal(user, principal.getAttributes(), authorities);
    }

    private static class UserOAuth2AuthentcatedPrincipal extends User implements OAuth2AuthenticatedPrincipal {
        private Map<String, Object> attributes;
        private Collection<GrantedAuthority> authorities;

        public UserOAuth2AuthentcatedPrincipal(
